(() => {
  ...
  function In(e) {
    (Y.includes(e) || Y.push(e), $n());
  }
  function Wt(e) {
    let t = Y.indexOf(e);
    t !== -1 && t > st && Y.splice(t, 1);
  }
  function $n() {
    !ot && !it && ((it = !0), queueMicrotask(Ln));
  }
  function Ln() {
    ((it = !1), (ot = !0));
    for (let e = 0; e < Y.length; e++) (Y[e](), (st = e));
    ((Y.length = 0), (st = -1), (ot = !1));
  }
  var M,
    D,
    z,
...
`
  ...
  function Un(e, t, r) {
    ...
    return (
      ...
      if (typeof n == "function") {
        let l = n.call(a, n, c).catch((u) => se(u, r, t));
        n.finished
          ? (he(i, n.result, c, s, r), (n.result = void 0))
          : l
              .then((u) => {
                he(i, u, c, s, r);
              })
  ...
  function he(e, t, r, n, i) {
    if (ae && typeof t == "function") {
      ...
      o instanceof Promise
        ? o.then((s) => he(e, s, r, n)).catch((s) => se(s, i, t))
        : e(o);
    } else
  ...
  function pr(e, t, r = {}) {
    ...
    if (t.includes("await")) {
      ...
      return typeof l == "function" && ae ? l.apply(o, s) : l;
    }
  }
  var Et = "x-";
  function R(e = "") {
  ...
  function Jn(e, t) {
    let r = X.indexOf(e.type) === -1 ? wt : e.type,
      n = X.indexOf(t.type) === -1 ? wt : t.type;
  ...
  function $(e, t) {
    ...
    for (; n; ) ($(n, t, !1), (n = n.nextElementSibling));
  }
  function w(e, ...t) {
  ...
  function L(e, t) {
    if (e) {
      ...
      if (
        ...
        return L(e.parentNode.host, t);
      if (e.parentElement) return L(e.parentElement, t);
    }
  }
  function Cr(e) {
  ...
  function ni(e, t, r) {
    ...
    let s = !t.includes("opacity") && !t.includes("scale"),
      ...
      l = a ? 0 : 1,
      u = c ? be(t, "scale", 95) / 100 : 1,
      p = be(t, "delay", 0) / 1e3,
      v = be(t, "origin", "center"),
      O = "opacity, transform",
      T = be(t, "duration", 150) / 1e3,
      _ = be(t, "duration", 75) / 1e3,
  ...
  function Kr(e, t, r, n = !0) {
    ...
    if (e._x_inlineBindings && e._x_inlineBindings[t] !== void 0) {
      ...
      return ((i.extract = n), ke(() => N(e, i.expression)));
    }
    return Vr(e, t, r);
  }
  function Vr(e, t, r) {
  ...
  var te = {},
    Ur = !1;
  function Wr(e, t) {
    if ((Ur || ((te = M(te)), (Ur = !0)), t === void 0)) return te[e];
    ((te[e] = t),
      oe(te[e]),
      typeof t == "object" &&
        t !== null &&
  ...
  function Yr(e, t) {
    ...
    return e instanceof Element ? Tt(e, r()) : ((Jr[e] = r), () => {});
  }
  function Xr(e) {
    return (
  ...
  var We = (e) => {
    ...
    kt = We((e) => e.charAt(0).toUpperCase() + e.slice(1)),
    Gs = We((e) => (e ? `on${kt(e)}` : "")),
    Dt = (e, t) => e !== t && (e === e || t === t);
  var Pt = new WeakMap(),
    Ae = [],
  ...
  function Ai(e, t) {
    let r = function () {
      ...
      if (!Ae.includes(r)) {
        fn(r);
        try {
          return (Ci(), Ae.push(r), (B = r), e());
        } finally {
          (Ae.pop(), dn(), (B = Ae[Ae.length - 1]));
        }
      }
    };
    return (
  ...
  function k(e, t, r) {
    ...
    (i || n.set(r, (i = new Set())),
      i.has(B) ||
        ...
        B.deps.push(i),
        B.options.onTrack &&
          B.options.onTrack({ effect: B, target: e, type: t, key: r })));
  }
    ...
    if (t === "clear") s.forEach(c);
      ...
      switch ((r !== void 0 && c(s.get(r)), t)) {
        case "add":
          W(e)
            ? Ue(r) && c(s.get("length"))
            : (c(s.get(re)), ue(e) && c(s.get(It)));
          break;
        case "delete":
          W(e) || (c(s.get(re)), ue(e) && c(s.get(It)));
          break;
        case "set":
          ue(e) && c(s.get(re));
          break;
  ...
  var Ri = Mt("__proto__,__v_isRef,__isVue"),
    pn = new Set(
    ...
    return (
      ["includes", "indexOf", "lastIndexOf"].forEach((t) => {
        e[t] = function (...r) {
          ...
          let i = n[t](...r);
          return i === -1 || i === !1 ? n[t](...r.map(g)) : i;
        };
      }),
      ["push", "pop", "shift", "unshift", "splice"].forEach((t) => {
        e[t] = function (...r) {
          Oi();
          let n = g(this)[t].apply(this, r);
          return (dn(), n);
        };
      }),
      e
  ...
  function mn(e = !1, t = !1) {
    return function (n, i, o) {
      ...
      if (i === "__v_raw" && o === (e ? (t ? Wi : xn) : t ? Ui : gn).get(n))
        return n;
      let s = W(n);
      if (!e && s && ve(nn, i)) return Reflect.get(nn, i, o);
      let a = Reflect.get(n, i, o);
      return (qe(i) ? pn.has(i) : Ri(i)) || (e || k(n, "get", i), t)
        ? a
        : $t(a)
          ? !s || !Ue(i)
            ? a.value
  ...
  function Di(e = !1) {
    return function (r, n, i, o) {
      let s = r[n];
      if (!e && ((i = g(i)), (s = g(s)), !W(r) && $t(s) && !$t(i)))
        return ((s.value = i), !0);
      let a = W(r) && Ue(n) ? Number(n) < r.length : ve(r, n),
        c = Reflect.set(r, n, i, o);
      return (
        r === g(o) &&
          (a ? Dt(i, s) && J(r, "set", n, i, s) : J(r, "add", n, i)),
        c
      );
    };
  }
  ...
  function Ii(e, t) {
    ...
    return ((!qe(t) || !pn.has(t)) && k(e, "has", t), r);
  }
  function $i(e) {
    return (k(e, "iterate", W(e) ? "length" : re), Reflect.ownKeys(e));
  }
  var Li = { get: Ti, set: ki, deleteProperty: Pi, has: Ii, ownKeys: $i },
    ji = {
      get: Mi,
      set(e, t) {
        return (
  ...
  function sn(e, t) {
    ...
    let r = g(this),
      { has: n, get: i } = Qe(r),
      o = n.call(r, e);
    o ? _n(r, n, e) : ((e = g(e)), (o = n.call(r, e)));
    let s = i.call(r, e);
    return (
      r.set(e, t),
      o ? Dt(t, s) && J(r, "set", e, t, s) : J(r, "add", e, t),
      this
    );
  }
  function an(e) {
    ...
    return (n, i, o) =>
      i === "__v_isReactive"
        ...
        : i === "__v_isReadonly"
          ...
          : i === "__v_raw"
            ? n
            : Reflect.get(ve(r, i) && i in n ? r : n, i, o);
  }
  var Vi = { get: hn(!1, !1) };
  var qi = { get: hn(!0, !1) };
  function _n(e, t, r) {
  ...
  function Ji(e) {
    return e.__v_skip || !Object.isExtensible(e) ? 0 : Gi(Nt(e));
  }
  function et(e) {
  ...
  y(
    "refs",
    (e) => (e._x_refs_proxy || (e._x_refs_proxy = I(Yi(e))), e._x_refs_proxy),
  );
  function Yi(e) {
    let t = [];
    return (
  ...
  function En(e, t) {
    (e._x_ids || (e._x_ids = {}), e._x_ids[t] || (e._x_ids[t] = Ht(t)));
  }
  ...
  d(
    ...
    (e, { modifiers: t, expression: r }, { effect: n, cleanup: i }) => {
      ...
      let c = () => {
          let _;
          return (s((f) => (_ = f)), Rn(_) ? _.get() : _);
        },
        l = (_) => {
          let f;
          (s((h) => (f = h)),
            Rn(f) ? f.set(_) : a(() => {}, { scope: { __placeholder: _ } }));
        };
      typeof r == "string" &&
        e.type === "radio" &&
        m(() => {
      ...
      if (F) T = () => {};
        ...
        let _ = [],
          f = (h) => l(rt(e, t, h, c()));
        (u && _.push(V(e, "change", t, f)),
          p && _.push(V(e, "blur", t, f)),
          v &&
            _.push(
              V(e, "keydown", t, (h) => {
                h.key === "Enter" && f(h);
      ...
      if (
        ...
        let _ = V(e.form, "reset", [], (f) => {
          le(() => e._x_model && e._x_model.set(rt(e, t, { target: e }, c())));
        });
        i(() => _());
      }
      ((e._x_model = {
  ...
  d("cloak", (e) =>
    queueMicrotask(() => m(() => e.removeAttribute(R("cloak")))),
  );
  Le(() => `[${R("init")}]`);
  d(
    "init",
  ...
  function ao(e) {
    return F ? (Be ? !0 : e.hasAttribute("data-has-alpine-state")) : !1;
  }
    ...
    r((s) => {
      ...
      if (i(s))
        s = Object.entries(s).map(([f, h]) => {
          ...
          (n(
            (E) => {
              (u.includes(E) && w("Duplicate key on x-for", e), u.push(E));
            },
            { scope: { index: f, ...b } },
          ),
            l.push(b));
        ...
        for (let f = 0; f < s.length; f++) {
          ...
          (n(
            (b) => {
              (u.includes(b) && w("Duplicate key on x-for", e), u.push(b));
            },
            { scope: { index: f, ...h } },
          ),
            l.push(h));
      ...
      for (let f = 0; f < u.length; f++) {
        let h = u[f],
          b = c.indexOf(h);
        if (b === -1) (c.splice(f, 0, h), p.push([_, f]));
        else if (b !== f) {
      ...
      for (let f = 0; f < p.length; f++) {
        ...
        let C = l[b],
          ...
          qt = M(C);
        (P(de, qt, o),
          (de._x_refreshXForScope = (kn) => {
            Object.entries(kn).forEach(([Dn, Pn]) => {
              qt[Dn] = Pn;
            });
          }),
          m(() => {
      ...
      for (let f = 0; f < T.length; f++)
        a[T[f]]._x_refreshXForScope(l[u.indexOf(T[f])]);
      o._x_prevKeys = u;
    });
  }
  function lo(e) {
  ...
  K.setEvaluator(yt);
  K.setRawEvaluator(pr);
  K.setReactivityEngine({ reactive: et, effect: ln, release: un, raw: g });
  var Vt = K;
  window.Alpine = Vt;
  queueMicrotask(() => {
    Vt.start();
